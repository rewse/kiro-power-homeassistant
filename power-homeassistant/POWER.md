...
For more workflow examples (smart climate systems, voice assistant customization, advanced templates, mobile app integration, etc.), see `homeassistant-advanced-workflows.md`.
